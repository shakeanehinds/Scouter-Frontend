  ...
  return (
    <nav className=" px-5 w-screen h-12 bg-white relative top-0 left-0 flex justify-start">
      ...
      <div className="flex  flex-grow px-2 justify-end items-center">
        ...
        >
          <div className="mx-4 rounded-b-sm cursor-pointer transition-colors duration-500 ease-in-out hover:border-yellow-300 border-b-4 border-white w-max ">
            <a className="text-sm font-medium text-gray-800 leading-none">
              Companies
            </a>
          </div>
        </Link>
        <img
          ...
          className="w-8 h-8s rounded-full cursor-pointer"
          src="https://randomuser.me/api/portraits/women/24.jpg"
        ></img>
      </div>

      <div class={`${menuOpen} z-50 my-10 absolute top-0 right-2`}>
        <div class="bg-white rounded overflow-hidden shadow-lg">
          <div class="text-center p-6  border-b">
            <img
              ...
              alt="Randy Robertson"
            />
            <p class="pt-2 text-lg font-semibold">Alexis Brown</p>
            <p class="text-sm text-gray-600">alexis.brown@scouter.com</p>
            <div class="mt-5">
              <a
                href="#"
